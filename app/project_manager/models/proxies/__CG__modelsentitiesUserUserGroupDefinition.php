...
namespace proxies\__CG__\models\entities\User;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class UserGroupDefinition extends \models\entities\User\UserGroupDefinition implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserGroupDefinition $proxy) {
